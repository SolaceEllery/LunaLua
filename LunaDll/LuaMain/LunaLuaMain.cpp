...
void CLunaLua::setupDefaults()
{
    ...
    LUAHELPER_DEF_CONST(_G, HARM_TYPE_EXT_YOSHI_FIREBALL);
    LUAHELPER_DEF_CONST(_G, HARM_TYPE_EXT_TOAD_BOOMERANG);
    LUAHELPER_DEF_CONST(_G, HARM_TYPE_EXT_PLAYER_RINKA);

...
void fixup_Credits()
{
    ...
    if((gEpisodeSettings.displayOriginalCredits && !gEpisodeSettings.display13Credits) || (gEpisodeSettings.displayOriginalCredits && gEpisodeSettings.display13Credits))
    {
        ...
        VB6StrPtr* text_newSite = new VB6StrPtr(std::string("https://smbxgame.com"));
        ...
        MemoryUnlock_Memcpy((void*)0x008F7C52, text_newSite, 4);
    }
...
void fixup_Mushbug()
{
    // Fixes a bug with mushrooms hitting lava and crashing the game.
    PATCH(0xA2D08B)
